    ...
    <div style="font-family: 'Bai Jamjuree', sans-serif" class="min-h-screen flex flex-col bg-white">
                ...
                <div class="relative shrink-0">
                    <div 
                        ...
                        <div v-else class="flex flex-col items-center text-gray-400">
                            <svg 
                                xmlns="http://www.w3.org/2000/svg" class="w-14 h-14" fill="none" viewBox="0 0 24 24"
        ...
        <div class="max-w-5xl mx-auto w-full px-6 py-10 flex-1">
            ...
            <div 
                ...
                <svg 
                    xmlns="http://www.w3.org/2000/svg" class="w-28 h-28 text-gray-300" fill="none" viewBox="0 0 24 24"
            ...
            <div 
                v-else-if="activeTab === 'recipes' && recipes.length > 0"
                class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-5">
                <div 
                    v-for="(recipe, index) in recipes" :key="recipe.mid"
            ...
            <div v-if="activeTab === 'saved'" class="flex flex-col items-center justify-center py-20 gap-4">
                <div class="flex flex-col items-center text-gray-300">
                    <svg 
                        xmlns="http://www.w3.org/2000/svg" class="w-28 h-28" fill="none" viewBox="0 0 24 24"
                        stroke="currentColor" stroke-width="0.8">
                        <path 
                            stroke-linecap="round" stroke-linejoin="round"
