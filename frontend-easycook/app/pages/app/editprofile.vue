        ...
        <section class="max-w-5xl mx-auto w-full px-6 pb-16 flex flex-col gap-5">
            ...
            <div class="grid grid-cols-2 gap-5">
                ...
                <div class="flex flex-col gap-1.5">
                    ...
                    <div class="flex items-center w-full border rounded-md px-4 py-2.5 gap-2 transition" :class="errors.firstName
                        ? 'border-red-400 bg-red-50'
                        : 'border-gray-300 focus-within:ring-2 focus-within:ring-green-500'">
                        <svg v-if="errors.firstName" xmlns="http://www.w3.org/2000/svg"
                            class="w-4 h-4 text-red-400 flex-shrink-0" fill="none" viewBox="0 0 24 24"
                            stroke="currentColor" stroke-width="2">
                            <circle cx="12" cy="12" r="10" stroke="currentColor" stroke-width="2" fill="none" />
                            <path stroke-linecap="round" stroke-linejoin="round" d="M12 8v4m0 4h.01" />
                        </svg>
                        <input v-model="form.firstName" type="text" :placeholder="errors.firstName || ''"
                ...
                <div class="flex flex-col gap-1.5">
                    ...
                    <div class="flex items-center w-full border rounded-md px-4 py-2.5 gap-2 transition" :class="errors.lastName
                        ? 'border-red-400 bg-red-50'
                        : 'border-gray-300 focus-within:ring-2 focus-within:ring-green-500'">
                        <svg v-if="errors.lastName" xmlns="http://www.w3.org/2000/svg"
                            class="w-4 h-4 text-red-400 flex-shrink-0" fill="none" viewBox="0 0 24 24"
                            stroke="currentColor" stroke-width="2">
                            <circle cx="12" cy="12" r="10" stroke="currentColor" stroke-width="2" fill="none" />
                            <path stroke-linecap="round" stroke-linejoin="round" d="M12 8v4m0 4h.01" />
                        </svg>
                        <input v-model="form.lastName" type="text" :placeholder="errors.lastName || ''"
                            class="flex-1 bg-transparent outline-none text-sm"
